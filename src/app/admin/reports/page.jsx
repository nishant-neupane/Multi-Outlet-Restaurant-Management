    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50 dark:bg-slate-800">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-800 font-medium">Loading reports...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="h-screen bg-gray-50 dark:bg-slate-800 flex flex-col animate-fadeIn">
      ...
      <div className="flex-shrink-0 bg-white dark:bg-slate-800 border-b border-gray-200 px-8 py-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <button
            onClick={exportToCSV}
            className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex items-center justify-center py-4">
              <div className="relative w-40 h-40">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-200">Success Rate</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-slate-700">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-200">Per Order</p>
              ...
              {reportData.topDishes.map((dish, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-950 dark:text-white">{dish.name}</p>
